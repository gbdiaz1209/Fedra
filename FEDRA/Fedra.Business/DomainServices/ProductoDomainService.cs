...
namespace Fedra.Business.DomainServices
{
    public class ProductoDomainService
    {
        ...
        public class ProductoDomainService : IProductoDomainService
        {
            ...
            public async Task<(ValidationResultDto Validaciones, ProductoDto Producto)>
                UpdateProductoAsync(UpdateProductoCriteriaDto criteria)
            {
            ...
            public async Task<List<ProductoDto>> GetProductoPorEstadoAsync(long Id, int nombre)
            {
